...
export const PriceWithDiscount = ({ first_month_payed, price, discount }) => {
  ...
  return (
    <h3>
      ...
      {first_month_payed ? "Mes" : "Primer mes"}
      <CouponApplied coupon_name={coupon_name} percent={percent} />
    </h3>
  );
};

export const PriceWithoutDiscount = ({ first_month_payed, price }) => {
  return (
    <h3>
